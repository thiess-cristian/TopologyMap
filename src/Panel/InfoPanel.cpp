...
void InfoPanel::addInfoTab(std::shared_ptr<DataModel::Element> element)
{
    auto motionBodyModel = std::dynamic_pointer_cast<DataModel::MotionBody>(element);
    auto connectorModel = std::dynamic_pointer_cast<DataModel::Connector>(element);
    auto jointModel = std::dynamic_pointer_cast<DataModel::Joint>(element);
...
void InfoPanel::addMotionBodyInfo(std::shared_ptr<DataModel::MotionBody> motionBodyModel)
{
...
void InfoPanel::addConnectorInfo(std::shared_ptr<DataModel::Connector> connectorModel)
{
    QWidget* content = new QWidget(m_tab);
...
void InfoPanel::addJointInfo(std::shared_ptr<DataModel::Joint> jointModel)
{
    QWidget* content = new QWidget(m_tab);
